<?php /* Smarty version Smarty-3.1.19, created on 2018-09-19 21:01:29
         compiled from "modules/appagebuilder/views/templates/hook/ApRow.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18171131835ba29d09ad34d1-94152282%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'af9a5d9e853d3abcd9853acaa2bdbf4580935c7f' => 
    array (
      0 => 'modules/appagebuilder/views/templates/hook/ApRow.tpl',
      1 => 1526563872,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18171131835ba29d09ad34d1-94152282',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ba29d09b151b2_17698634',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ba29d09b151b2_17698634')) {function content_5ba29d09b151b2_17698634($_smarty_tpl) {?>
...
" <?php }?><?php if (isset($_smarty_tpl->tpl_vars['formAtts']->value['animation_duration'])&&$_smarty_tpl->tpl_vars['formAtts']->value['animation_duration']!='') {?> data-animation-duration="<?php echo htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['formAtts']->value['animation_duration'],'html','UTF-8'), ENT_QUOTES, 'UTF-8');?>
" <?php }?><?php if (isset($_smarty_tpl->tpl_vars['formAtts']->value['animation_iteration_count'])&&$_smarty_tpl->tpl_vars['formAtts']->value['animation_iteration_count']!='') {?> data-animation-iteration-count="<?php echo htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['formAtts']->value['animation_iteration_count'],'html','UTF-8'), ENT_QUOTES, 'UTF-8');?>
" <?php }?><?php if (isset($_smarty_tpl->tpl_vars['formAtts']->value['animation_infinite'])&&$_smarty_tpl->tpl_vars['formAtts']->value['animation_infinite']!='') {?> data-animation-infinite="<?php echo htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['formAtts']->value['animation_infinite'],'html','UTF-8'), ENT_QUOTES, 'UTF-8');?>
" <?php }?><?php }?>
...
<?php }?>
<?php if (isset($_smarty_tpl->tpl_vars['leoConfiguration']->value)&&$_smarty_tpl->tpl_vars['leoConfiguration']->value->get('APPAGEBUILDER_LOAD_STELLAR')) {?>
